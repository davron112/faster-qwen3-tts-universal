...
sf.write(os.path.join(SCRIPT_DIR, f'sample_streaming_{MODEL_SIZE}.wav'), streaming_audio, sr)
...
sf.write(os.path.join(SCRIPT_DIR, f'sample_nonstreaming_{MODEL_SIZE}.wav'), audio_list[0], sr)
